	    ...
	    $gridColumns = [
    					['class' => 'yii\grid\SerialColumn'],
							...
							[
								...
								'filter'=>[''=>'All','Broadband'=>'Broadband','Dedicated'=>'Dedicated','Local Loop'=>'Local Loop'],
								'value'=>function($data)
								{
			...
			$gridColumns = [
    				['class' => 'yii\grid\SerialColumn'],
							...
							[
								'attribute'=>'speed_type',
			   					'value'=>'linkcustomerpackage.speed.speed_type',
			   					'filter' => Html::activeDropDownList($searchModel, 'fk_speed_id', ArrayHelper::map(Speed::find()->asArray()->all(), 'speed_id', 'speed_type'),['class'=>'form-control','prompt' => 'Speed Type']),
			   					'footer'=>'Total'
							],
							...
							[
								'header'=>'Action',
								'options'=>['width'=>100],
								'template'=>'{view} {update} {delete} {disconnect} {temp_disconnect} {sales} {add} {history}',
								'buttons' => [
									'view' => function ($url,$model) {
										return Html::a(
											'<span class="fa fa-eye"></span>', 
									...
									'temp_disconnect' => function ($url,$model) {
										return Html::a(
											...
											['customer/tempdisconnect','id'=>$model->customer_id],['data-confirm'=>"Are you sure you want to temporary disconnect this record?"]);
									},
									...
									'history' => function ($url,$model,$key) {
										return Html::a('<i class="fa fa-eye"></i>', ['/customer/customerhistory','id'=>$model->customer_id],['title'=>'View History','target'=>'_blank']);
									},
								],
								'class' => 'yii\grid\ActionColumn'
							],
