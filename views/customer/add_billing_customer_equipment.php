...
<?php 
	echo Html::a('Back',['billing'], ['class' => 'btn btn-default']);echo "<br/>";
?>
</div>
	...
	<div class="box-body">
		<div class="tbllanguage-form">
			<div class="prospect-form">
	            <div class='row'>
	            	<?php $form = ActiveForm::begin(['method' => 'post','id'=>'noofequipment_form','action' =>['customer/getcustomerequipment','id' =>$id]])?>
	            	...
	            	<?php $form = ActiveForm::begin(['method' => 'post','id'=>'addequipment_form','action' =>['customer/addbillingcustomerequipment','id' =>$id]])?>
		            	<?php
		            	if(isset($intNoOfEqu) && $intNoOfEqu != NULL){
		            		for ($i=0; $i < $intNoOfEqu; $i++) { ?>
								<div class="col-md-12 table-responsive">
									<div class="col-md-2">
										<?php echo $form->field($model, 'fk_equipments_id['.$i.'][]')->dropDownList($arrEquipList,['class'=>'fk_equipments_idClass_'.$i.' form-control','prompt'=>'Select Model Type','onchange'=>'$.post( "'.Yii::$app->urlManager->createUrl('customer/getbillingcustomerequpment?intId='.$i.'&id=').'"+$(this).val(), function( data ) { $(".brandNameClass_'.$i.'").html( data );
												$(".equmPrice").keyup(function() {
												   ...
												   $(this).parent().parent().find(".equmTotal").val(intTotalPrice);
												});
