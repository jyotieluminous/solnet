					 	...
					 	<tbody>
					 		<?php $intCnt = 1;
					 			foreach ($arrResultEqupment as $key => $arrValue) { 
					 				//echo '<pre>';print_r($arrValue);echo '</pre>';die;
					 		...
					 		?>
					 				<tr>
					 					...
					 					<td>
					 						<?php echo Html::a('<i class="fa fa-trash deleteBtn"></i>', ['/customer/deleteequipment','id'=>$arrValue->id],['title'=>'Add Equipments','onclick'=>"return confirm('Are you sure you want to delete this item?')"]); ?>
					 					</td>
					 				</tr>
					 		<?php
					 				}
