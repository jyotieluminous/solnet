						...
						'columns' => [
						    ...
						    'buttons'  => [
						        ...
						        'print' => function ($url, $data) {
			                        ...
			                        return  Html::a('<i class="fa fa-print"></i>', ['/customer/installationprint','id'=>$data->customer_id], [
			                            'title'=>'Print',
			                            'target'=>'_blank',
			                            'data-pjax'=>'0'
			                         ]);
								...
								'trash' => function ($url, $data) {
										return Html::a(
											...
											['customer/deletepending','id'=>$data->customer_id],['data-confirm'=>"Are you sure you want to delete this record ?"]);
