						...
						<table id="dataTable" class="table" >
						 <tbody>
							<?php
								...
								if(!empty($serviceDetailModel)){
									
									foreach($serviceDetailModel as $value=>$key){ ?>
										<tr>
											<td >
											...
											<td>
												<?php echo $form->field($serviceDetail, 'service')->textInput(['maxlength' => true,'name' => 'service[]','value' => $key->service ]) ?>
											</td>
											<td>
							
												<?php echo $form->field($serviceDetail, 'service_price')->textInput(['maxlength' => true,'name' => 'service_price[]','value' => $key->service_price] ) ?>
											</td>
											<td>
							
												<?php echo $form->field($serviceDetail, 'service_quantity')->textInput(['maxlength' => true,'name' => 'service_quantity[]','value' => $key->service_quantity]) ?>
											</td>
						  ...
						  <tr>
							...
							<?php echo $form->field($serviceDetail, 'service')->textInput(['maxlength' => true,'name' => 'service[]']) ?>
							</td>
							<td>
							
								<?php echo $form->field($serviceDetail, 'service_price')->textInput(['maxlength' => true,'name' => 'service_price[]']) ?>
							</td>
							<td>
							
								<?php echo $form->field($serviceDetail, 'service_quantity')->textInput(['maxlength' => true,'name' => 'service_quantity[]']) ?>
							</td>
