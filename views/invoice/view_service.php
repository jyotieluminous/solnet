...
<div style="max-width:800px;margin:auto;padding:30px;font-size:16px;line-height:24px;font-family:'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif;color:#555; ">
  ...
  <table cellpadding="7" cellspacing="0" style="line-height: inherit;text-align: left;width: 100%;">
    <tr class="top">
	  ...
	  <table style=" line-height: inherit;text-align: left;width: 100%;border-spacing:0;">
          <tr>
           ...
           <?php if($header==1){
					//$url = Yii::$app->request->hostInfo.Yii::$app->request->baseUrl.'/web/images/solnet-logo.png';
			?>
            <td style="border-bottom:solid 3px #4286d4;padding-right:30px;">
			 <!--<img width="160px" src="<?php //echo $url; ?>" > -->
			</td>  
			<td style="border-bottom:solid 3px #4286d4; font-size:12px !important;">
                ...
                <p style=" padding:0 0 5px 0; margin:0px;">
                <?php echo $headerAddressInvoice;?>
                <br />
                <?php echo $headerTelephoneTelephone;?>
				<br> Website : www.solnet.net.id<br /></p>
				</td>
            <?php } ?>
    ...
    <tr class="information">
      <td colspan="2"><table style="width:110%;">
          <tr>
	...
	<tr>
		<td colspan="2">
			...
			foreach($serviceDetail as $key => $value){  ?>
					  ...
					  <tr style="width:100%;">
						<td style="border-bottom: 1px solid #eee; padding:5px 0;" align="left"><?php echo $i; ?></td>
						<td style="border-bottom: 1px solid #eee; padding:5px 0;" align="left"><?php echo trim($value->service); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:5px 0;" align="center"><?php echo trim($value->service_quantity); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:5x 0;" align="center"><?php echo trim(number_format($value->service_price,2)); ?></td>
            <?php $intTotal = $value->service_price*$value->service_quantity; ?>
						<td style="border-bottom: 1px solid #eee; padding:5px 0;" align="right"><?php echo trim(number_format($intTotal,2)); ?></td>
					  </tr>
					
			<?php  
			$totalPayable = $totalPayable + ($value->service_price*$value->service_quantity);
			$i++; } ?>
   ...
   <?php if(!empty($model->vat)) { ?>
	...
	<tr>
      <td style="background: #eee none repeat scroll 0 0;border-bottom: 1px solid #ddd;font-weight: bold;">Usage Details</td>
      <td style="background: #eee none repeat scroll 0 0;border-bottom: 1px solid #ddd;font-weight: bold;"></td>
    </tr>
    <tr>
     ...
     <tr class="item">
      ...
      <td style="text-align:right; border-bottom: 1px solid #eee;"><?php echo date('d-M-Y',strtotime($model->usage_period_from)).' To '.date('d-M-Y',strtotime($model->usage_period_to)); ?> </td>
    </tr>
