...
$link = 'customercomplain/returnequipmentbroadband/';
			...
			<div class="prospect-form">
                <div class="row" >
                 	<div class="col-md-12">
                 		...
                 		<input type="hidden" name="equipment_id" value="<?php echo $model->id ?>">
						<div class="form-group required col-md-12">
                 		...
                 		<div class="form-group required col-md-12">
							...
							<textarea class="form-control" name="return_reasone"><?php echo $model->return_reasone ?></textarea>
						</div>
					</div>                     					
                  </div>
            </div>
