		...
		<td colspan="2">
			...
			foreach($serviceDetail as $key => $value){  ?>
					  ...
					  <tr style="width:100%;">
						...
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="center"><?php echo trim($value->service); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="center"><?php echo trim($value->service_quantity); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10x 0;" align="center"><?php echo trim($value->service_price); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="right"><?php echo $value->service_price*$value->service_quantity; ?></td>
					  </tr>
