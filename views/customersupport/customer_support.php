						...
						[
							...
							'buttons'=>[
								...
								'pay' =>function ($url,$model,$key) {
									return Html::a('<i class="fa fa-credit-card-alt"></i>',['customersupport/paycustomersupport','id'=>$model->customer_invoice_id],['title'=>'Pay Invoice Amount']);
								},
							]
						],
];
...
<?php echo Html::a('Reset Filters', ['/customersupport/index'], ['class' => 'btn btn-success']) ?>
