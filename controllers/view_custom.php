		...
		<td colspan="2">
			...
			foreach($serviceDetail as $key => $value){  ?>
					  ...
					  <tr style="width:100%;">
						...
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="center"><?php echo trim($value->description); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="center"><?php echo trim($value->quantity); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10x 0;" align="center"><?php echo trim($value->price); ?></td>
						<td style="border-bottom: 1px solid #eee; padding:10px 0;" align="right"><?php echo $value->price*$value->quantity; ?></td>
					  </tr>
